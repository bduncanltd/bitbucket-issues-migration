...
def default_migration_log_path(output_dir: Path | None) -> Path | None:
    """Return the default project log path for an output directory."""

    if output_dir is None:
        return None
    return output_dir.parent / "migration.log"
